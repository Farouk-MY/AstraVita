...
const RecordCard = ({record,onNavigate}) => {
  return (
    <div className='flex flex-col rounded-xl border shadow-sm border-neutral-800 bg-[#13131a] '>
        ...
        className='inline-flex cursor-pointer items-center justify-between rounded-b-xl border-t px-4 py-3 text-sm text-neutral-400 md:px-5 border-neutral-800 hover:bg-neutral-800 '
        >
            {record.recordName}
            <IconChevronRight />
        </a>
